...
console.log = ('Je getallen waren '+ getal1 + getal2 + 'De som is: '+ (getal1 + getal2) + 'Het verschil is: '+ (getal1 - getal2) + 'Het product is: '+ (getal1 * getal2) + 'De deling is: '+ (getal1 / getal2));
